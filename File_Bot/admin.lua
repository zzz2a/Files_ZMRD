...
if text == "المشرفين" and BasicConstructor(msg) then
...
if text == 'تفعيل تاك للمشرفين' and BasicConstructor(msg) then   
if database:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = ' *⌔︙تم تفعيل امر تاك للمشرفين*'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = ' *⌔︙بالتاكيد تم تفعيل امر تاك للمشرفين*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل تاك للمشرفين' and BasicConstructor(msg) then  
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
database:set(bot_id..'Cick:all'..msg.chat_id_,true)  
Text = '\n *⌔︙تم تعطيل امر تاك للمشرفين*'
else
Text = '\n *⌔︙بالتاكيد تم تعطيل امر تاك للمشرفين*'
end
send(msg.chat_id_, msg.id_,Text) 
end
